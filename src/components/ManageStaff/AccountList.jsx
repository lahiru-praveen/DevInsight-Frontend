import { Select, Input, InputGroup, InputLeftElement, Button } from '@chakra-ui/react';
...
const MyComponent = () => {
    ...
    const handleRoleChange = (e) => {
        ...
        console.log("Role Changed:", e.target.value !== activeMembers[index].role); // Debug log
    };
...
//             <div className='flex flex-row space-x-5 py-5'>
//                 <div className='basis-1/4'>
//                     <Select placeholder='Filter option' onChange={handleRoleFilterChange}>
//                         <option value='All'>All</option>
//                         <option value='Quality assurance'>Quality assurance</option>
//                         <option value='Developer'>Developer</option>
//                     </Select>
