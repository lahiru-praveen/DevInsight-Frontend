...
import {BsChatLeftTextFill, BsFileEarmarkMedicalFill} from "react-icons/bs";
...
export default function Submissions({ submission }) {
    ...
    const file_name = f_name === '' ?<BsChatLeftTextFill size="30px" />: (f_name)
    ...
    return (
        <Card>
            <Flex flexDirection="row" className="bg-[#EBEBEB] mb-2 mt-1">
                ...
                <CardHeader className="mr-4 w-[250px]">
                    <Text className="font-bold" fontSize="14px">{file_name}</Text>
                </CardHeader>
