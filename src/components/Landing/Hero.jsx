  ...
  return (
    <div className="relative">
      ...
      <div className='mx-auto w-4/5 py-24'>
        <div id="home" className='md:max-w-[1480px] mx-auto grid md:grid-cols-2 max-w-[600px] px-4 md:px-0 mb-40'>
          <div className='flex flex-col justify-start gap-2 flex justify-center h-full mx-5'>
            <div className='flex justify-start'>
              <img src={Devinsight} className="w-1/2" />
            </div>
        ...
        <Box id="about-us" className="bg-white p-8 rounded-lg shadow-lg mb-40">
