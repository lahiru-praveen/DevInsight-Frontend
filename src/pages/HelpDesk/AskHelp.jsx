...
// //                     };
// //
// //                     // Send a POST request to the server to save the request data
// //                     // const response = await axios.post(
// //                     //     'http://localhost:8000/request',
// //                     //     requestData,
// //                     const response = await axios.post(
...
function AskHelp() {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 divide-x py-4 px-4 mx-4">
                <div className="bg-gray-200 rounded-lg">
                    <Tabs className="grid grid-cols-2 divide-x py-4 px-4 mx-4" variant="enclosed" colorScheme="blue" height={"1100"}>
                        <TabList>
                            <Tab>Preview</Tab>
                            <Tab>Review</Tab>
                        </TabList>
